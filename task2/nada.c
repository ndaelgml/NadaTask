...
int reg()
{
    ...
    {
        printf("Maximum number of Customer reached.\n");
        printf("=======================================\n ");
        return 0;
    }
    ...
    printf("Enter active: ");
    scanf("%s", New_Customer.check_Customer_Active.Customer_Active);
...
int login()
{
    ...
    for (int i = 0; i < Customer_number; i++)
    {
        if (strcmp(Customername, Customer[i].Customer_name) == 0 && strcmp(Customerpassword, Customer[i].Customer_password) == 0)
        {
            ...
            if (strcmp("0", Customer[i].check_Customer_Active.Customer_Active) == 0 || strcmp("false", Customer[i].check_Customer_Active.Customer_Active) == 0)
            {
